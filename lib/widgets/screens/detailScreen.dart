...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  void addToCart() {
    ...
    if (existingCartIndex != -1) {
      ...
      final existingCart = cartProvider.demoCarts[existingCartIndex];
      cartProvider.demoCarts[existingCartIndex] = Cart(
        product: existingCart.product,
        numOfItem: existingCart.numOfItem + quantity,
      );
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color:
            const Color(0xfffbb448).withOpacity(widget.isSelected ? 1 : 0),
          ),
        ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isSelected ? const Color(0xfffbb448) : Colors.transparent,
        ),
        shape: BoxShape.circle,
      ),
      child: DecoratedBox(
